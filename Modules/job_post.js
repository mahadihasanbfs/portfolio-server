...
const { job_application_collection } = require("../Collection/all_collection");
...
const delete_job_post = async (req, res, next) => {
    ...
    try {
        const result = await job_application_collection.deleteOne({ _id: new ObjectId(id) });
