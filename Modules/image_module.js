...
const upload_image = async (req, res, next) => {
    try {
        ...
        const image_url = `https://bright-server.vercel.app/api/v1/image/${result.insertedId}.${fileType}`;
        const blur_image_url = `https://bright-server.vercel.app/api/v1/image/blur/${result.insertedId}.${fileType}`;
